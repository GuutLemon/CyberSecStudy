...
total = set()
total |= {len(count_tiles('R', (i, 0), set())) for i in range(len(grid))}
total |= {len(count_tiles('L', (i, len(grid) - 1), set())) for i in range(len(grid))}
total |= {len(count_tiles('D', (0, j), set())) for j in range(len(grid[0]))}
total |= {len(count_tiles('U', (len(grid[0]) - 1, j), set())) for j in range(len(grid[0]))}
